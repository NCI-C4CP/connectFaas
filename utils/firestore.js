...
// This call has been removed from the MyConnect app as of the Jan 2025 release. Ok to remove in Feb 2025 or later.
...
const storeKitReceipt = async (pkg) => {
    try {
        ...
        await db.runTransaction(async (transaction) => {
             ...
             */
            if ((pkg[collectionDateTimeStamp] > pkg[received] || pkg[collectionDateTimeStamp] < kitData[shipped]) && !pkg["collectionDateChecked"]) {
...
module.exports = {
    ...
    recordExists,
    validateIDToken,
    verifyTokenOrPin, // @ deprecated OK to remove Feb 2025
    verifyPin,
    linkParticipanttoFirebaseUID, // @ deprecated OK to remove Feb 2025
